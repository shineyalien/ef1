...
CREATE TABLE "users" (
    ...
    "fbrSubmissionNotifications" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "businesses" (
    ...
    "lastTokenValidation" TIMESTAMP(3),
    "logoUrl" TEXT,
    "productionTokenValidated" BOOLEAN NOT NULL DEFAULT false,
    "sandboxTokenValidated" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "invoices" (
    ...
    "retryProcessing" BOOLEAN NOT NULL DEFAULT false,
    "retryProcessingSince" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "fbr_business_scenario_mappings_isActive_idx" ON "fbr_business_scenario_mappings"("isActive");
