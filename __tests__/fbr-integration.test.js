...
describe('FBR Integration Components', () => {
  ...
  describe('FBR Client', () => {
    ...
    beforeAll(() => {
      ...
      const { PRALAPIClient } = require('../libs/fbr-integration/src/client');
      client = new PRALAPIClient(TEST_CONFIG.credentials);
    });
    
    test('Client initialization', () => {
      expect(client).toBeDefined();
      expect(client.constructor.name).toBe('PRALAPIClient');
    });
    ...
    test('Public API endpoints - Provinces', async () => {
      try {
        ...
        console.warn('Provinces API test skipped due to network error:', error.message);
      }
    });
    ...
    test('Public API endpoints - Document Types', async () => {
      try {
        ...
        // Network errors are acceptable in test environment
        console.warn('Document Types API test skipped due to network error:', error.message);
      }
    });
  });
  ...
  describe('Tax Calculator', () => {
    ...
    beforeAll(() => {
      const { PakistaniTaxCalculator } = require('../libs/fbr-integration/src/tax-calculator');
    ...
    test('Tax calculation validation', () => {
      ...
      const taxCalculation = calculator.calculateItemTax(standardItem, context);
      const { TaxValidationService } = require('../libs/fbr-integration/src/tax-calculator');
  ...
  describe('QR Code Generator', () => {
    test('QR code SVG generation', async () => {
      const { QRCodeGenerator } = require('../libs/fbr-integration/src/qr-generator');
  ...
  describe('FBR Scenarios', () => {
    test('Manufacturing scenarios retrieval', () => {
      const { getApplicableScenarios } = require('../apps/web/src/lib/fbr-scenarios');
    ...
    test('Scenario validation', () => {
      const { validateScenarioApplicability } = require('../apps/web/src/lib/fbr-scenarios');
  ...
  describe('Error Handling', () => {
    test('Invalid invoice data rejection', () => {
      const { validateInvoiceData } = require('../libs/fbr-integration/src/validators');
